        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-2">
            <p
              ...
              style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 700, fontSize: 'var(--font-size-worship-type)' }}
            >
              02-000-0000
            </p>
            <p
              className="text-white/40"
              style={{ fontFamily: "'Noto Sans KR', sans-serif", fontSize: 'var(--font-size-small)' }}
            >
              서울특별시 한소망교회
            </p>
            <p
