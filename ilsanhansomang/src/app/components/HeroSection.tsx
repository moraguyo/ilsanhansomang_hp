        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-10">
          {navItems.map((item) => (
            <a
              key={item}
              href="#"
              className="text-white tracking-tight hover:text-white/70 transition-colors whitespace-nowrap"
              style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 700, fontSize: 'var(--font-size-nav)' }}
            >
              {item}
            </a>
          ))}
