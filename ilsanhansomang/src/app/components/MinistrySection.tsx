        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ministries.map((m, i) => (
            ...
            >
              ...
              >
                <p
                  className="text-white/70 tracking-widest uppercase mb-1"
                  style={{ fontFamily: "'Playfair Display', serif", fontStyle: 'italic', fontSize: 'var(--font-size-base)' }}
                >
                  {m.titleEn}
                </p>
                <h3
                ...
                <p
                  ...
                  style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300, fontSize: 'var(--font-size-small)' }}
                >
                  {m.description}
                </p>
              </div>
