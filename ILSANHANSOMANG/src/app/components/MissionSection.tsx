        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              fontSize: isMobile ? 'clamp(1.6rem, 6vw, 2.2rem)' : 'clamp(1.8rem, 3.2vw, 3rem)',
                ...
                >
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <span style={{ fontFamily: fontKR, fontWeight: 700, fontSize: isMobile ? '0.82rem' : 'clamp(0.85rem, 1.2vw, 1.05rem)', color: '#fff' }}>{card.name}</span>
                      <span style={{ fontFamily: fontKR, fontSize: '0.73rem', color: 'rgba(255,255,255,0.72)', marginBottom: 8 }}>{card.sub}</span>
